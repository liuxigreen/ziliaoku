# -*- coding: utf-8 -*-
"""Claude Skills 实战 · 公众号深读版 → 摸鱼绿排版 HTML（复用 gzh_style）。
输出: gzh_assets/claude_skills_wechat_排版_摸鱼绿(moyu-green).html
...
SRC = 'D:/WorkBuddyProjects/ziliaoku/output/posts/2026-07-28/claude_skills_practice/claude_skills_wechat.md'
OUT_DIR = 'D:/WorkBuddyProjects/ziliaoku/output/posts/2026-07-28/claude_skills_practice/gzh_assets'
...
COVER = {
    ...
    'sub': '把会忘的流程，变成不会忘的文件',
    'src': '打工人可复制',
    'tag_a': '不是聊天', 'tag_b': '是焊死流程',
}
INTRO_LEAD = '这周 GitHub 上 awesome-claude-skills 冲上 Trending，1000+ 现成 skill 随便挑。但我三个月前就给自己写了个——把双平台发文流程焊进文件。这篇讲清楚：为什么单聊会失忆、我的 Skill 长啥样、你怎么写第一个。'

SIGN_NAME = '小木'
SIGN_DESC = '用 AI 把内容工作流跑起来。译介一手好工具，讲人话的落地判断，不画饼。'
...
def main():
    ...
    out = os.path.join(OUT_DIR, 'claude_skills_wechat_排版_摸鱼绿(moyu-green).html')
