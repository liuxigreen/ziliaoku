# -*- coding: utf-8 -*-
"""我用Claude Code踩的3个坑 · 公众号深读版 → 摸鱼绿排版 HTML（复用 gzh_style）。
输出: gzh_assets/claude_code_pitfalls_wechat_排版_摸鱼绿(moyu-green).html
...
SRC = 'D:/WorkBuddyProjects/ziliaoku/output/posts/2026-07-22/claude_code_pitfalls/claude_code_pitfalls_wechat.md'
OUT_DIR = 'D:/WorkBuddyProjects/ziliaoku/output/posts/2026-07-22/claude_code_pitfalls/gzh_assets'

COVER = {
    'tag': 'AI 编程 · 避坑实测',
    't1': '我用Claude Code',
    't2': '踩的3个坑',
    'sub': '半年 hardcore 实测 · 3次翻车复盘',
    'src': '开发者可复制',
    'tag_a': 'Agent别甩', 'tag_b': '思考别外包',
}
INTRO_LEAD = '用 CC 半年，踩的坑比教程都多。这 3 个坑我替你踩了：当黑盒甩需求、不写文档失忆、全自动一把梭雪崩。每个都附"怎么避"，Agent 是加速器，不是脑子。'
...
def main():
    ...
    out = os.path.join(OUT_DIR, 'claude_code_pitfalls_wechat_排版_摸鱼绿(moyu-green).html')
