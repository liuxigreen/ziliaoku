# -*- coding: utf-8 -*-
"""WorkBuddy 专题 · 公众号深读版 → 摸鱼绿排版 HTML（复用 gzh_style，解析 md 自动渲染）。
输出: gzh_assets/workbuddy_wechat_排版_摸鱼绿(moyu-green).html
...
SRC = 'D:/WorkBuddyProjects/ziliaoku/output/posts/2026-07-20/workbuddy_feature/workbuddy_wechat.md'
OUT_DIR = 'D:/WorkBuddyProjects/ziliaoku/output/posts/2026-07-20/workbuddy_feature/gzh_assets'

COVER = {
    'tag': 'AI 工具 · 译介实测',
    't1': 'WorkBuddy',
    't2': '能自己干活的',
    'sub': 'hy3 模型限免 2 周，把重复活甩给 AI 打工',
    'src': '打工人可复制',
    'tag_a': 'hy3限免', 'tag_b': '邀请送积分',
}
INTRO_LEAD = '免费窗口就 2 周，先占坑，把重复活甩出去，你只管做判断。'
...
def main():
    ...
    out = os.path.join(OUT_DIR, 'workbuddy_wechat_排版_摸鱼绿(moyu-green).html')
