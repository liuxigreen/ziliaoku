#!/usr/bin/env python3
"""生成 Codex 换肤 双版配图（纯 PIL，零成本、中文不乱码）。
...
def gzh_header():
    ...
    # 标题（两行）
    for i, ln in enumerate(wrap("Codex 换肤/宠物：免费开源方案", F(44, True), W-300, d)):
    ...
    img.save(os.path.join(OUT, "gzh_header_codex.png"))
    print("gzh header done")


if __name__ == "__main__":
    cover()
    card(1, "居然有人卖课？", "Codex 换肤/宠物\n其实有免费开源方案", "xhs_card1_codex_3x4.png")
    card(2, "两个仓库搞定", "Dream Skin 直接换肤\nCodeDrobe 系统换肤+AI生成", "xhs_card2_codex_3x4.png")
    card(3, "三步上手", "下载 → 安装脚本 → 切换主题\n不喜欢就一键还原", "xhs_card3_codex_3x4.png")
    gzh_header()
    print("ALL DONE")
