# -*- coding: utf-8 -*-
"""Codex 换肤 · 公众号深读版 → 摸鱼绿排版 HTML（复用 gzh_style，解析 md 自动渲染）。
输出: gzh_assets/codex_dream_skin_wechat_排版_摸鱼绿(moyu-green).html
...
SRC = 'D:/WorkBuddyProjects/ziliaoku/output/posts/2026-07-16/codex_dream_skin/codex_dream_skin_wechat.md'
OUT_DIR = 'D:/WorkBuddyProjects/ziliaoku/output/posts/2026-07-16/codex_dream_skin/gzh_assets'

COVER = {
    'tag': 'AI 工具 · 译介实测',
    't1': 'Codex 也能换皮肤',
    't2': '养宠物？',
    'sub': '免费开源方案，20 分钟让 Codex 穿上新皮肤',
    'src': '个人创作者可复制',
    'tag_a': 'Codex', 'tag_b': '换肤',
}
INTRO_LEAD = '工具本身免费，课程就不应该成为入门门槛。'
...
def main():
    ...
    out = os.path.join(OUT_DIR, 'codex_dream_skin_wechat_排版_摸鱼绿(moyu-green).html')
