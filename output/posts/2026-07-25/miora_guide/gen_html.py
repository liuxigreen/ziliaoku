# -*- coding: utf-8 -*-
"""腾讯 Miora 攻略 · 公众号深读版 → 摸鱼绿排版 HTML（复用 gzh_style）。
输出: gzh_assets/miora_guide_wechat_排版_摸鱼绿(moyu-green).html
...
SRC = 'D:/WorkBuddyProjects/ziliaoku/output/posts/2026-07-25/miora_guide/miora_guide_wechat.md'
OUT_DIR = 'D:/WorkBuddyProjects/ziliaoku/output/posts/2026-07-25/miora_guide/gzh_assets'

COVER = {
    'tag': 'AI 创意工具 · 新上线',
    't1': '腾讯 Miora 全量上线',
    't2': '这个新工具值不值得冲',
    'sub': '注册送 1000 积分 · 攻略 + 我的判断',
    'src': '打工人可复制',
    'tag_a': '不是生图工具', 'tag_b': '记忆 + 协同',
}
INTRO_LEAD = '做内容卡在视觉上的时间，比写正文还多。腾讯刚全量上线 Miora、注册送 1000 积分，我扒完官方信息把"能干嘛、适合谁、坑在哪"整理了一遍，顺便说说它和咱内容工作流的关系。'
...
def main():
    ...
    out = os.path.join(OUT_DIR, 'miora_guide_wechat_排版_摸鱼绿(moyu-green).html')
