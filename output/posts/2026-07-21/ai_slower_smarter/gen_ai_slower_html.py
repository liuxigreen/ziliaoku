# -*- coding: utf-8 -*-
"""AI让我写代码更快却变笨了 · 公众号深读版 → 摸鱼绿排版 HTML（复用 gzh_style）。
输出: gzh_assets/ai_slower_wechat_排版_摸鱼绿(moyu-green).html
...
SRC = 'D:/WorkBuddyProjects/ziliaoku/output/posts/2026-07-21/ai_slower_smarter/ai_slower_wechat.md'
OUT_DIR = 'D:/WorkBuddyProjects/ziliaoku/output/posts/2026-07-21/ai_slower_smarter/gzh_assets'

COVER = {
    'tag': 'AI 编程 · 认知实测',
    't1': '用AI写代码',
    't2': '我反而变笨了',
    'sub': '3周实测 · 3个把思考抢回来的动作',
    'src': '打工人可复制',
    'tag_a': '更快≠更强', 'tag_b': '思考别外包',
}
INTRO_LEAD = 'AI 让我产出更快，却没让我更强。这 3 周我刻意把"思考"抢回来，记下了三个真实变化和三个自救动作——AI 是加速器，不是脑子。'
...
def main():
    ...
    out = os.path.join(OUT_DIR, 'ai_slower_wechat_排版_摸鱼绿(moyu-green).html')
